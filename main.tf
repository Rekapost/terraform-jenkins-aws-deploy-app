...
module "jenkins" {
  ...
  user_data_install_jenkins =base64decode(file("${path.module}/jenkins-installer.sh.b64"))
  #user_data_install_jenkins = base64decode(file("./jenkins-installer.sh.b64"))
  #user_data_install_jenkins = base64encode(file("./jenkins-runner-script/jenkins-installer.sh"))
...
resource "aws_s3_bucket" "remote_state_bucket" {
  bucket = "dev-proj-1-jenkins-remote-state-bucket-us-east"
  region = "us-east-1"
}
*/
